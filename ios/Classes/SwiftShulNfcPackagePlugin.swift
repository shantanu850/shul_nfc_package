...
@available(iOS 11.0, *)
public class SwiftShulNfcPackagePlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "shul_nfc_package", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "com.shullabs.shul_nfc_package.flutter_nfc_reader", binaryMessenger: registrar.messenger())
        let instance = SwiftShulNfcPackagePlugin()
...
// MARK: - NFC Actions
@available(iOS 11.0, *)
extension SwiftShulNfcPackagePlugin {
...
// MARK: - NFCDelegate
@available(iOS 11.0, *)
extension SwiftShulNfcPackagePlugin : NFCNDEFReaderSessionDelegate {
...
@available(iOS 11.0, *)
extension SwiftShulNfcPackagePlugin: FlutterStreamHandler {
