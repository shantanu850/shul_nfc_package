package com.shullabs.shul_nfc_package
...
class ShulNfcPackagePlugin : FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, NfcAdapter.ReaderCallback {
  ...
  private fun NfcAdapter.startNFCReader() {
    listeners.add(NfcScanner(this@ShulNfcPackagePlugin))
    enableReaderMode(activity, this@ShulNfcPackagePlugin, nfcFlags, null)
  }
  ...
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    ...
    methodChannel = MethodChannel(messenger, "shul_nfc_package")
    methodChannel!!.setMethodCallHandler(this)
    eventChannel = EventChannel(messenger, "com.shullabs.shul_nfc_package.shul_nfc_package")
