...
class ShulNfcPackage {
  static const MethodChannel _channel = MethodChannel('shul_nfc_package');
  static const stream = EventChannel('com.shullabs.shul_nfc_package.shul_nfc_package');
